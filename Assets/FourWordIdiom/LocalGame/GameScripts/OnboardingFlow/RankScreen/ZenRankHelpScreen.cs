...
public class ZenRankHelpScreen : UIWindow
{
    ...
    protected  void Start()
    {
        ...
        wordtips.text = MultilingualManager.Instance.GetString("FindIdioms");
        slidertips.text = MultilingualManager.Instance.GetString("ObtainZen");
        rewardtips.text = MultilingualManager.Instance.GetString("ImproveRanking");
