...
public class HorLockAchieveItem : MonoBehaviour
{
    ...
    public void SetTaskData(AchieveDataItem data)
    {
        achieveDataItem = data;
        InitUI();
    }
    ...
    public void InitUI()
    {
        ...
        achieveicon.sprite =LoadheadIcon("an"+achieveDataItem.achieveIcon);
